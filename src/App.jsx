      ...
      <Container>
        <div className="py-8 grid gap-6 md:grid-cols-3 text-sm text-muted-foreground">
          ...
          <div className="text-xs">
            ...
            <div className="mt-3">
              {/* Hidden test route link for manual checks */}
...
function TestsPage() {
  ...
  // Test 1: Disclosures list has 3 items
  ...
  // Test 2: Required routes exist
  const requiredRoutes = ["/", "/products", "/research", "/about", "/faq", "/disclosures", "/contact"];
  tests.push({ name: "Has 7 primary routes", pass: requiredRoutes.length === 7 });

  // Test 3: Basic sanity – Button component available
  tests.push({ name: "UI Button imported", pass: typeof Button !== "undefined" });

  useEffect(() => {
    // Console assertions to aid debugging in dev tools
